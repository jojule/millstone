...
/** <p>A specialized set of identified Items. Basically the Container is a
 * set of Items, but it imposes certain constraints on its contents. These
 * constraints state the following:</p>
 * 
 * <ul>
 ...
 * </ul>
 * 
 * <p>The Container can be visualized as a representation of a relational
 * database table. Each Item in the Container represents a row in the table,
 * and all cells in a column (identified by a Property ID) have the same
 * data type. Note that as with the cells in a database table, no Property 
 * in a Container may be empty, though they may contain <code>null</code>
 * values.</p>
 * 
 * <p>Note that though uniquely identified, the Items in a Container are not
 * neccessarily {@link Container.Ordered ordered} or 
 * {@link Container.Indexed indexed}.</p>
 * 
 * <p><img src=doc-files/Container_full.gif></p>
 * 
 * <p>The Container interface is split to several subinterfaces so that a
 * class can implement only the ones it needs.</p>
 * 
 * @author  IT Mill Ltd
 * @version @VERSION@
 * @since 3.0
...
public interface Container {
    ...
    /** Gets the ID's of all Properties stored in the Container. The ID's
     * are returned as a unmodifiable collection.
     * 
     ...
     * the Container. If the Container does not contain the Property,
    ...
    public boolean containsId(Object itemId);
         ...
         * <p>Item is returned, and it is ready to have its Properties
         * modified. Returns <code>null</code> if the operation fails or the
         * Container already contains a Item with the given ID.</p>
         *
         * <p>This functionality is optional. </p>
         *
         * @param itemId ID of the Item to be created
         * @return Created new Item, or <code>null</code> in case of a
         * failure
         */
        public Item addItem(Object itemId)
        throws UnsupportedOperationException;
        
        /** Creates a new Item into the Container, and assign it an
         * automatic ID. 
         * 
         * <p>The new ID is returned, or <code>null</code> if the
        ...
        /** Adds a new Property to all Items in the Container. The Property
         ...
         * Container. Note that the Property will be removed from all Items
         * in the Container.
         *
         * This functionality is optional. 
         *
         ...
         * 
         * <p>Note that Property ID and 
         * type information is preserved.
         * This functionality is optional.</p>
         *
         * @return <code>true</code> if the operation succeeded,
         * <code>false</code> if not
         */
    ...
    public interface Ordered extends Container {
         ...
         * 
         * @param itemId ID of an Item in the Container
        ...
        /** Tests if the Item corresponding to the given Item ID is the
         ...
         * <p>Adding an item after null item adds the item as first item of the
         * ordered container.</p>
         * 
         * @param previousItemId Id of the previous item in ordered container.
         ...
         * @return Returns new item or null if the 
         * operation fails.
         */
    ...
    public interface Indexed extends Ordered {
         ...
         * 
         * @param itemId ID of an Item in the Container
         * @return index of the Item, or -1 if the Container does not
         * include the Item
         */
        public int indexOfId(Object itemId);
        
        /** Get the ID of an Item by an index number. The following is
         * true for the index: 0 <= index < size().
         * 
       ...
       /** Add new item at given index.
         * <p>The indexes of the item currently in the given position and all the
         * following items are incremented.</p>
         * 
         * @param index Index to add the new item.
         * @return Returns item id the the created new item or null if the 
         * operation fails.
         */
    ...
    /** <p>Interface for <code>Container</code> classes whose Items can be
     * arranged hierarchically. This means that the Items in the container
     * belong in a tree-like structure, with the following quirks:</p>
     * 
     * <ul>
     * <li> The Item structure may have more than one root elements
     * <li> The Items in the hierarchy can be declared explicitly to be able
     * or unable to have children.
     * </ul>
     */
    public interface Hierarchical extends Container {

		/** Gets the IDs of all Items that are children of the specified
		 * Item. The returned collection is unmodifiable.
		 * 
		 * @param itemId ID of the Item whose children the caller is
		 * interested in
		 * @return An unmodifiable
		 * {@link java.util.Collection collection} containing the IDs of all
		 * other Items that are children in the container hierarchy
		 */
        public Collection getChildren(Object itemId);

		/** Gets the ID of the parent Item of the specified Item.
		 * 
		 * @param itemId ID of the Item whose parent the caller
		 * wishes to find out.
		 * @return the ID of the parent Item. Will be <code>null</code> if
		 * the specified Item is a root element.
		 */
        public Object getParent(Object itemId);

		/** Gets the IDs of all Items in the container that don't have a
		 * parent. Such items are called <code>root</code> Items. The
		 * returned collection is unmodifiable.
		 * 
		 * @return An unmodifiable
		 * {@link java.util.Collection collection} containing IDs of all
		 * root elements of the container
		 */
        public Collection rootItemIds();

    	/** <p>Sets the parent of an Item. The new parent item must exist
    	 ...
    	 * root) by setting the parent <code>null</code>.</p>
    	 * 
         ...
         * Container also implements the <code>Managed</code> interface,
         * the items created with <code>newItem</code> can have children by
         * default.</p>
         * 
         ...
         * Container and it can have children, <code>false</code> if it's
         * not found from the container or it can't have children.
         */
        public boolean areChildrenAllowed(Object itemId);

        /** <p>Sets the given Item's capability to have children. If the
         * Item identified with <code>itemId</code> already has children
         * and <code>areChildrenAllowed</code> is false this method fails
         * and <code>false</code> is returned; the children must be first
         * explicitly removed with
         * {@link #setParent(Object itemId, Object newParentId)} or
         * {@link org.millstone.base.data.Container#removeItem(Object itemId)}.</p>
         * 
    	 * <p>This operation is optional. If it is not implemented, the
    	 * method always returns <code>false</code>.</p>
    	 * 
         * @param itemId ID of the Item in the container whose child
         * capability is to be set
         * @param areChildrenAllowed boolean value specifying if the Item
        ...
        /** <p>Tests if the Item specified with <code>itemId</code> has any
         * child Items, that is, is it a leaf Item. The
         * {@link #getChildren(Object itemId)} method always
         * returns <code>null</code> for leaf Items.</p>
         * 
         * <p>Note that being a leaf does not imply whether or not an Item
         * is allowed to have children.</p>.
         * 
         * @param itemId ID of the Item whose leaf status is to be tested
    ...
    /** Interface implemented by viewer classes capable of using a Container
     * as a data source.
     */
     ...
     * Container. Implementing this interface means that the Container
     * serving as the data source of the editor can be modified through 
     * it. Note that not implementing the <code>Container.Editor</code>
     * interface does not restrict the class from editing the Container
     * contents internally.
     */
    ...
    /* Contents change event ******************************************* */
     ...
     /** An <code>Event</code> object specifying the Container whose
      * Item set has changed. Note that these events are triggered only
      * through succesful calls to the <code>newItem()</code> and
      * <code>removeAllItems</code> methods in the Container.Managed
      * interface.
      */
     ...
     * <code>ItemSetChangeEvent</code> listeners. By implementing this
     * interface a class explicitly announces that it will generate a
     * <code>ItemSetChangeEvent</code> when its contents are modified.
     * 
    ...
    /* Property set change event ******************************************** */
     ...
     /** An <code>Event</code> object specifying the Container whose
      * Property set has changed. Note that these events are triggered only
      * through succesful calls to the <code>addProperty</code> and
      * <code>removeProperty</code> methods in the Container.Managed
      * interface.
      */
    ...
    public interface PropertySetChangeListener {
        ...
        /** Notifies this listener that the Containers contents has
         * changed.
         * 
     ...
     * interface a class explicitly announces that it will generate a
     * <code>PropertySetChangeEvent</code> when its contents are modified.
     * 
     * Note that the general Java convention is not to explicitly declare
     * that a class generates events, but to directly define the
     * <code>addListener</code> and <code>removeListener</code> methods.

...
public class Window extends Panel implements URIHandler, ParameterHandler {
	 ...
	 * <p>To show the window in application, it must be added to application with
	 * <code>Application.addWindow()</code> method.</p>
	 * 
	 * <p>The windows are scrollable by default.</p>
	 *
	 ...
	 *  Returns the window where this component belongs to.
	 *  If the component does not yet belong to a window
	 *  the returns null.
	 ...
	 *  Returns the application where this component belongs to.
	 *  If the component does not yet belong to a application
	 *  the returns null.
	 ...
	 *  Parent is the visual parent of a component. Each component
	 *  can belong to only one ComponentContainer at time.
	 ...
	 * containers add method. Setting parent is not allowed for the window,
	 * and thus this call should newer be called.
	 ...
	 * 	 
	 *  @return Name of the theme used in window. If the theme for this individual 
	 *  window is not explicitly set, the application theme is used instead. If 
	 *  application is not assigned the terminal.getDefaultTheme is used. If terminal 
	 ...
	 * 
	 * @param theme New theme for this window. Null implies the default theme.
	 */
	...
	/** Open the given resource in named terminal window. Empty or <code>null</code>
	...
	/** Open the given resource in named terminal window with given 
	 * size and border properties. Empty or <code>null</code>
	 * window name results the resource to be opened in this window.
	 */
	public void open(
		Resource resource,
	...
	/**
	 * Returns the full url of the window, this returns window specific url
	 * even for the main window. 
	 * @return String
	 */
	public URL getURL() {
	 ...
	 * {@link org.millstone.base.Application#addWindow(Window)}
	 * method should be used to add the window to an application and
	 * {@link org.millstone.base.Application#removeWindow(Window)}
	 * method for removing the window from the applicion. These
	 * methods call this method implicitly.</p>
	 * 
	 * <p>The method invokes {@link Component#attach()} and 
	 * {@link Component#detach()} methods when necessary.<p>
	 * 
	...
	/**
	 * Sets the name.
	 * <p>The name of the window must be unique inside the 
	 * application. Also the name may only contain the following characters: 
	 * a-z, A-Z and 0-9.</p> 
	 * 
	 * <p>If the name is null, the the window is given name automatically
	 * when it is added to an application.</p>

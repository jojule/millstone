...
public class FeatureServerEvents extends Feature {
	...
	protected String getDescriptionXHTML() {
		return "<p>Millstone component framework supports both transactional and "
			...
			+ "passed immediately when the user causes them using the user "
			+ "interface. </p>"
			...
			+ "pages after the components has received and handled the events. "
			+ "In the web-environment web browser is always the active party that "
			...
			+ "WebAdapter to automatically create JavaScript that updates the "
			...
			+ "of the mechanism. If you read the source, you will notice that "
			+ "the program does not contain any support for sending events, as "
